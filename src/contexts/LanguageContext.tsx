...
const translations = {
  ru: {
    ...
    // About
    aboutTitle: "Обо мне",
    aboutText: "Привет! Я продакт-менеджер, который верит в силу идей и сильных команд. Люблю погружаться в данные, изучать пользователей, \"разгонять\" идеи и генерить тысячу новых -  превращая хаос гипотез в новые концепции. Прокладываю свой путь в бигтехе, в свободное время веду тг-канал про продакт-менеджмент и расту вместе со своими проектами.",
